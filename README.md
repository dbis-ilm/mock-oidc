...
We forked this repo as there were a few issues due to rust's openidconnect crate expecting reponses to be formatted differently.

Its intention is to be used for local development and CI pipelines.
...
```
import "github.com/dbis-ilm/mock-oidc"
```
